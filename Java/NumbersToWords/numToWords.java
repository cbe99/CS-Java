...
public class numToWords {
    ...
    public static void numberToWords(int number) {
        ...
        for (int i = 0; i < count; i++) { // 12300 : i = 0 reversed = 321 = one, count = 5; i = 1; count 5 two; i = 2
                                          // three; now 1%0 = 0 zero i = 3; i = 4 zero
